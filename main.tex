...
\begin{document}
    ...
    \texttt{sleek} is the main package. It imports the packages (\cf{} Table \ref{tab:sleek_relevant_packages}) and setups the settings that make Sleek Template easy to use.
    ...
    The \texttt{siunitx} package provides three commands to typeset numbers and quantities -- \texttt{\tbs{}num}, \texttt{\tbs{}si} and \texttt{\tbs{}SI} -- as well as various units (\cf{} Table \ref{tab:siunitx_units}).
